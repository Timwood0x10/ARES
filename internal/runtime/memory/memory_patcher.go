...
//
// The returned instance carries only a config and its lock — it implements
// MemoryConfigStore and no memory-operation surface. Callers must use it
// exclusively as a MemoryPatchExecutor store.
