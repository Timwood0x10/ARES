...
// Evolution trajectory recording (v0.4.0 M3-1): captures a per-generation
...
// Dashboard (v0.4.0 M3-1). Thread-safe; unbounded history is capped by
...
// (v0.4.0 M3-1). Each entry mirrors GenerationSnapshot. Returns nil when
// nothing is recorded.
