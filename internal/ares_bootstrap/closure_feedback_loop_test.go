...
// ── §8 验收标准（ga-runtime-evolution-design-zh.md §8, 断言 1–4）──────────
//
...
// TestClosure_VerifyGate_RejectsWorseCandidate (§8 断言 1: 验证门生效).
...
// TestClosure_Promote_KeepsPrevious (§8 断言 2: 正确保留).
...
// TestClosure_Degradation_TriggersRollback (§8 断言 3: 失败回退).
...
// TestClosure_AgentPassivity_ReadOnlyStrategySource (§8 断言 4: agent 被动性).
