...
func runRealEvolution(ctx context.Context, generations, popSize int) (*genome.Population, []*mutation.Strategy, error) {
...
func main() {
	...
	pop, strategies, err := runRealEvolution(ctx, 5, 16)
	if err != nil {
