// serve_arena — the chaos-engineering arena CLI (run/validate/list/serve/
// survival/inspect subcommands) and its demo providers, split out of serve.go
// (M-C2; this was arena.go before the merge). Bodies are moved verbatim;
