...
完成 1–6 后，本文 §4 的非阻塞项可原样写进 release note 放行。
...
| `internal/ares_memory/`（含 ProductionMemoryManager PG 半边）**已删除** | 目录不存在；`e37058ed` |
...
| 文档 | 状态 | 本文关系 |
|------|------|---------|
| `ARCHITECTURE_DIAGRAM.md` | 锚 `2aeaf942`，落后 10 提交 | **本文取代其架构图部分**；建议将本文 §3–§4 回填或把该文件改为指向本文 |
