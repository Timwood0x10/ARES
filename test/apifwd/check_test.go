...
// api/evolution and api/discovery were REMOVED outright (C1.4, 2026-09-10):
// their forwarding layers had no remaining external consumers once the six
// examples migrated to internal/evoapi and internal/discoveryapi. The other
// seven forwarding packages stay (examples still consume them) and remain
// locked below.
